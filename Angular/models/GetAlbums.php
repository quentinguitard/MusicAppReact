...
{ 
	...
	{
		if($reponse = $bdd->query("SELECT id,artist_id,name,description,cover,cover_small,DATE_FORMAT(FROM_UNIXTIME(release_date),'%d-%m-%Y') as \"release_date\",popularity FROM albums"))
		{
